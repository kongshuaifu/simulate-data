...
class threadcontroller(object):
    ...
    def PostUsinglog(date, count):
        list_platform = readfile.readtext("platform.txt","usinglog/")
        list_appkey_android = readfile.readtext("android_appkey.txt","usinglog/")
        list_appkey_iphone = readfile.readtext("iphone_appkey.txt","usinglog/")
        list_activities_android = readfile.readtext("android_activities.txt","usinglog/")
        list_activities_iphone = readfile.readtext("iphone_activities.txt","usinglog/")
        list_version = readfile.readtext("version.txt","usinglog/")
        list_hours = readfile.readtext("hour.txt","usinglog/")
        ...
        for i in range(0, int(count)):
            ...
            for j in range(0, usepages):
                ...
                print "        [" + c["start_millis"] + "]-[" + c["end_millis"] + "]" + "Activity Usage:" + str(j) + "/" + str(usepages)
                #end activities loop
    ...
    def PostEvent(date, count):
        list_platform = readfile.readtext("platform.txt","event/")
        list_appkey_android = readfile.readtext("android_appkey.txt","event/")
        list_appkey_iphone = readfile.readtext("iphone_appkey.txt","event/")
        list_event_android = readfile.readtext("android_event.txt","event/")
        list_event_iphone = readfile.readtext("iphone_event.txt","event/")
        list_activities_android = readfile.readtext("android_activities.txt","usinglog/")
        list_activities_iphone = readfile.readtext("iphone_activities.txt","usinglog/")
        list_version = readfile.readtext("version.txt","event/")
        list_hours = readfile.readtext("hour.txt","event/")
    ...
    def PostError(date, count):
        list_platform = readfile.readtext("platform.txt","error/")
        list_appkey_android = readfile.readtext("android_appkey.txt","error/")
        list_appkey_iphone = readfile.readtext("iphone_appkey.txt","error/")
        list_activities_android = readfile.readtext("android_activities.txt","error/")
        list_activities_iphone = readfile.readtext("iphone_activities.txt","error/")
        list_version = readfile.readtext("version.txt","error/")
        list_hours = readfile.readtext("hour.txt","error/")
        list_osversion_android = readfile.readtext("android_os_version.txt","error/")
        list_osversion_iphone = readfile.readtext("iphone_os_version.txt","error/")
        list_devicename_android = readfile.readtext("android_devicename.txt","error/")
        list_devicename_iphone = readfile.readtext("iphone_devicename.txt","error/")
